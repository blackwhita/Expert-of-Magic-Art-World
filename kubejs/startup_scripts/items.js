onEvent('item.registry', event => {
    ...
    //avaritia
    event.create('avaritia:akashic_record').displayName('§6kashic_record').texture('avaritia:items/akashic_record')
    event.create('avaritia:ultimate_stew').displayName('§6ultimate_stew').texture('avaritia:items/ultimate_stew')
    event.create('avaritia:cosmic_meatballs').displayName('§6cosmic_meatballs').texture('avaritia:items/cosmic_meatballs')
    //emmaw
    ...
    //pneu
    event.create('eomaw:ingot_iron_compressed_mould').displayName('ingot_iron_compressed_mould').texture('eomaw_items:items/ingot_iron_compressed_mould')
    //thermal   v4.0.0
    event.create('eomaw:rf_coil_creative_augment_underfill').displayName('rf_coil_creative_augment_underfill').texture('eomaw_items:items/rf_coil_creative_augment_underfill')
    event.create('eomaw:aquamarine_wrapped').displayName('aquamarine_wrapped').texture('eomaw_items:items/aquamarine_wrapped')
})//