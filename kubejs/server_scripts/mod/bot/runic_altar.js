onEvent('recipes', (event) => {
    ...
    const recipes = [
        ...
        {
            inputs: ['botania:mana_tablet', 'kubejs:blockcasing_plain', 'botania:livingrock_bricks', 'botania:gaia_spreader', 'botania:livingrock_bricks', 'botania:livingrock_bricks', 'botania:livingrock_bricks'],
            mana: 96000*2,
            output: 'kubejs:overlay_mana_output',
            count: 1,
        },
        {
            inputs: ['botania:mana_tablet', 'kubejs:blockcasing_plain', 'botania:livingrock_bricks', 'botania:livingrock_bricks', 'botania:livingrock_bricks', 'botania:livingrock_bricks', 'mythicbotany:mana_collector'],
            mana: 96000*2,
