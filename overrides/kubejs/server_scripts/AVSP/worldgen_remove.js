...
//COPPER
	event.removeOres((ores) => {
		ores.blocks = ['immersiveengineering:ore_copper', 'mekanism:copper_ore', 'create:copper_ore', 'thermal:copper_ore', 'tmechworks:copper_ore', 'mysticalworld:copper_ore', 'silents_mechanisms:copper_ore', 'occultism:copper_ore', 'iceandfire:copper_ore', 'routerreborn:copper_ore', 'projectred-exploration:copper_ore'];
	});
